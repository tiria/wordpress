...
*/
	...
	$layoutWidth = ( wm_option( 'layout-width' ) ) ? ( wm_option( 'layout-width' ) ) : ( 'r1160' );

	//Start including files and editing output
		@readfile( (file_exists(get_stylesheet_directory().'/assets/css/normalize.css')) ? get_stylesheet_directory().'/assets/css/normalize.css' : get_template_directory().'/assets/css/normalize.css' );
		@readfile( (file_exists(get_stylesheet_directory().'/assets/css/core.css')) ? get_stylesheet_directory().'/assets/css/core.css' : get_template_directory().'/assets/css/core.css' );
		@readfile( (file_exists(get_stylesheet_directory().'/assets/css/columns-content.css')) ? get_stylesheet_directory().'/assets/css/columns-content.css' : get_template_directory().'/assets/css/columns-content.css' );
		@readfile( (file_exists(get_stylesheet_directory().'/assets/css/columns-' . $layoutWidth . '.css')) ? get_stylesheet_directory().'/assets/css/columns-' . $layoutWidth . '.css' : get_template_directory().'/assets/css/columns-' . $layoutWidth . '.css' );
		@readfile( (file_exists(get_stylesheet_directory().'/assets/css/wp-styles.css')) ? get_stylesheet_directory().'/assets/css/wp-styles.css' : get_template_directory().'/assets/css/wp-styles.css' );
		@readfile( (file_exists(get_stylesheet_directory().'/assets/css/forms.css')) ? get_stylesheet_directory().'/assets/css/forms.css' : get_template_directory().'/assets/css/forms.css' );
		@readfile( (file_exists(get_stylesheet_directory().'/assets/css/typography.css')) ? get_stylesheet_directory().'/assets/css/typography.css' : get_template_directory().'/assets/css/typography.css' );
		@readfile( (file_exists(get_stylesheet_directory().'/assets/css/icons.css')) ? get_stylesheet_directory().'/assets/css/icons.css' : get_template_directory().'/assets/css/icons.css' );
		@readfile( (file_exists(get_stylesheet_directory().'/assets/css/header.css')) ? get_stylesheet_directory().'/assets/css/header.css' : get_template_directory().'/assets/css/header.css' );
		@readfile( (file_exists(get_stylesheet_directory().'/assets/css/slider.css')) ? get_stylesheet_directory().'/assets/css/slider.css' : get_template_directory().'/assets/css/slider.css' );
		@readfile( (file_exists(get_stylesheet_directory().'/assets/css/content.css')) ? get_stylesheet_directory().'/assets/css/content.css' : get_template_directory().'/assets/css/content.css' );
		@readfile( (file_exists(get_stylesheet_directory().'/assets/css/comments.css')) ? get_stylesheet_directory().'/assets/css/comments.css' : get_template_directory().'/assets/css/comments.css' );
		@readfile( (file_exists(get_stylesheet_directory().'/assets/css/sidebar.css')) ? get_stylesheet_directory().'/assets/css/sidebar.css' : get_template_directory().'/assets/css/sidebar.css' );
		@readfile( (file_exists(get_stylesheet_directory().'/assets/css/footer.css')) ? get_stylesheet_directory().'/assets/css/footer.css' : get_template_directory().'/assets/css/footer.css' );
		@readfile( (file_exists(get_stylesheet_directory().'/assets/css/shortcodes.css')) ? get_stylesheet_directory().'/assets/css/shortcodes.css' : get_template_directory().'/assets/css/shortcodes.css' );
		@readfile( (file_exists(get_stylesheet_directory().'/assets/css/borders.css')) ? get_stylesheet_directory().'/assets/css/borders.css' : get_template_directory().'/assets/css/borders.css' );
		@readfile( (file_exists(get_stylesheet_directory().'/assets/css/skins/'.$themeSkin)) ? get_stylesheet_directory().'/assets/css/skins/'.$themeSkin : get_template_directory().'/assets/css/skins/'.$themeSkin );
		if('r930' === $layoutWidth || 'r1160' === $layoutWidth){
			@readfile( (file_exists(get_stylesheet_directory().'/assets/css/responsive.css')) ? get_stylesheet_directory().'/assets/css/responsive.css' : get_template_directory().'/assets/css/responsive.css' );
		}
